...
•	La complejidad temporal es O(n log n), porque es la complejidad clásica de la ordenación por fusión. La complejidad espacial es O(log n), porque utilicé una recursión que puede ser log n de profundidad.
